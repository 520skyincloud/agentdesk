    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        {agentStats.teamLoads.length === 0 ? (
          <div className="rounded-2xl border border-dashed border-[#dbe7f6] bg-[#f6f9ff] px-4 py-8 text-center text-sm text-muted-foreground shadow-inner shadow-blue-100/30">
          ...
          agentStats.teamLoads.map((item) => (
            <div key={item.teamId} className="rounded-2xl border p-4">
              ...
              <div className="mt-4 h-2 rounded-full bg-[#e8f0fb]">
                <div
