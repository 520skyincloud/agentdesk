...
export type UpdateWxWorkProtocolAISettingsPayload = {
  id: number
  aiReplyEnabled: boolean
  autoAcceptFriendRequest: boolean
  autoAcceptFriendRemarkTemplate: string
...
export type UpdateKnowledgeCandidatePayload = {
  id: number
  question: string
  answer: string
  summary: string
...
export type KnowledgeCandidateExportResult = {
  markdownPath: string
  jsonlPath: string
  count: number
}
...
export function fetchWxWorkProtocolInstances(
  ...
  return request<PageResult<WxWorkProtocolInstance>>(
    `/api/dashboard/wxwork-protocol-instance/list${toQueryString(query)}`
  )
}

export function fetchWxWorkProtocolInstance(id: number) {
  return request<WxWorkProtocolInstance>(`/api/dashboard/wxwork-protocol-instance/${id}`)
}

export function createWxWorkProtocolInstance(payload: CreateWxWorkProtocolInstancePayload) {
  return request<WxWorkProtocolInstance>("/api/dashboard/wxwork-protocol-instance/create", {
    method: "POST",
...
export function deleteWxWorkProtocolInstance(id: number) {
  return request<void>("/api/dashboard/wxwork-protocol-instance/delete", {
    method: "POST",
    body: JSON.stringify({ id }),
  })
}

export function setWxWorkProtocolNotifyUrl(id: number, notifyUrl: string) {
  return request<void>("/api/dashboard/wxwork-protocol-instance/set_notify_url", {
    method: "POST",
    body: JSON.stringify({ id, notifyUrl }),
  })
}

export function setWxWorkProtocolAIReplyEnabled(id: number, enabled: boolean) {
  return request<void>("/api/dashboard/wxwork-protocol-instance/set_ai_reply_enabled", {
    method: "POST",
...
export function updateWxWorkProtocolAISettings(payload: UpdateWxWorkProtocolAISettingsPayload) {
  return request<void>("/api/dashboard/wxwork-protocol-instance/update_ai_settings", {
    method: "POST",
    body: JSON.stringify(payload),
  })
}
...
export function stopWxWorkProtocolInstance(id: number) {
  return request<string>("/api/dashboard/wxwork-protocol-instance/stop", {
    method: "POST",
    body: JSON.stringify({ id }),
  })
}

export function logoutWxWorkProtocolInstance(id: number) {
  return request<string>("/api/dashboard/wxwork-protocol-instance/logout", {
    method: "POST",
    body: JSON.stringify({ id }),
  })
}

export function syncWxWorkProtocolProfile(id: number) {
  return request<string>("/api/dashboard/wxwork-protocol-instance/sync_profile", {
    method: "POST",
    body: JSON.stringify({ id }),
  })
}

export function getWxWorkProtocolCorpInfo(id: number) {
  return request<string>("/api/dashboard/wxwork-protocol-instance/get_corp_info", {
    method: "POST",
    body: JSON.stringify({ id }),
  })
}

export function setWxWorkProtocolProxy(id: number, proxy: string) {
  return request<string>("/api/dashboard/wxwork-protocol-instance/set_proxy", {
    method: "POST",
    body: JSON.stringify({ id, proxy }),
  })
}

export function syncWxWorkProtocolFriendRequests(id: number) {
  return request<string>("/api/dashboard/wxwork-protocol-instance/sync_friend_requests", {
    method: "POST",
    body: JSON.stringify({ id }),
  })
}

export function acceptWxWorkProtocolFriendRequest(payload: {
  id: number
  username: string
  scene?: string
  remark?: string
...
export function fetchKnowledgeCandidates(
  query?: Record<string, string | number | undefined>
) {
  return request<PageResult<KnowledgeCandidate>>(
    `/api/dashboard/knowledge-candidate/list${toQueryString(query)}`
  )
}

export function updateKnowledgeCandidate(payload: UpdateKnowledgeCandidatePayload) {
  return request<void>("/api/dashboard/knowledge-candidate/update", {
    method: "POST",
    body: JSON.stringify(payload),
  })
}

export function approveKnowledgeCandidate(id: number) {
  return request<void>("/api/dashboard/knowledge-candidate/approve", {
    method: "POST",
    body: JSON.stringify({ id }),
  })
}
...
export function markKnowledgeCandidateImported(id: number) {
  return request<void>("/api/dashboard/knowledge-candidate/mark_imported", {
    method: "POST",
    body: JSON.stringify({ id }),
  })
}

export function exportKnowledgeCandidatesWeekly(payload: {
  storeId?: number
  year?: number
  week?: number
  status?: string
}) {
  return request<KnowledgeCandidateExportResult>(
    "/api/dashboard/knowledge-candidate/export-weekly",
    {
      method: "POST",
      body: JSON.stringify(payload),
    }
