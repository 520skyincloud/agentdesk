...
func ModelProfileTemplatePostGet(ctx *gin.Context) {
	...
	result, err := services.ModelProfileTemplateService.Get(operator)
	if err != nil {
		httpx.WriteJSON(ctx, err)
		return
	}
...
func ModelProfileTemplatePostUpdate(ctx *gin.Context) {
	...
	result, err := services.ModelProfileTemplateService.Update(req, operator)
	if err != nil {
		httpx.WriteJSON(ctx, err)
		return
	}
...
func ModelProfileTemplatePostTest(ctx *gin.Context) {
	...
	req := request.TestModelProfileSlotRequest{}
	if err := params.ReadJSON(ctx, &req); err != nil {
		httpx.WriteJSON(ctx, err)
		return
	}
	result, err := services.ModelProfileTemplateService.TestSlot(ctx, req, operator)
	if err != nil {
		httpx.WriteJSON(ctx, err)
		return
	}
