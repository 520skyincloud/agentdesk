...
type KnowledgeResourceItemResponse struct {
	ID                       int64        `json:"id"`
	KnowledgeResourceGroupID int64        `json:"knowledgeResourceGroupId"`
...
type KnowledgeCandidateResponse struct {
	...
	ReviewUserID      int64      `json:"reviewUserId"`
...
type KnowledgeCandidateExportResponse struct {
