...
const (
	...
	IMEventTypeRouteChange   IMEventType = "route_change"
)
...
type ConversationRouteStatus string
...
const (
	...
	ConversationRouteStatusClosed             ConversationRouteStatus = "CLOSED"
)
...
type MessageSyncDirection string
...
const (
	MessageSyncStatusPending MessageSyncStatus = "pending"
	MessageSyncStatusSuccess MessageSyncStatus = "success"
	MessageSyncStatusFailed  MessageSyncStatus = "failed"
	MessageSyncStatusSkipped MessageSyncStatus = "skipped"
)
