...
var knownMessages = map[string]map[string]string{
	LocaleEnUS: {
		...
		"CheckPoint 与接待策略不匹配":                               "The checkpoint does not belong to this reception strategy.",
		"会话与接待策略不匹配":                                        "The conversation does not belong to this reception strategy.",
		"接待策略不存在":                                           "Reception strategy not found.",
		"接待策略不存在或未启用":                                       "Reception strategy not found or not enabled.",
		"接待策略不存在或已停用":                                       "Reception strategy not found or disabled.",
		"接待策略不存在或不属于当前公司":                                   "Reception strategy not found or not in the active company.",
		"接待策略不属于接入渠道所在公司":                                   "The reception strategy does not belong to the channel company.",
		"接待策略不属于会话所在公司":                                     "The reception strategy does not belong to the conversation company.",
		"接待策略与会话绑定不一致":                                      "The reception strategy does not match the conversation binding.",
		...
		"接待策略不能为空":                                          "Reception strategy is required.",
		...
		"企业微信接入渠道未绑定接待策略":                                   "The WeCom channel is not linked to a reception strategy.",
		"企业微信接入渠道绑定的接待策略不存在或已禁用":                            "The reception strategy linked to this WeCom channel does not exist or has been disabled.",
		...
		"客服组仍被内部接待策略引用，无法删除":                                "This agent team is referenced by an internal reception strategy and cannot be deleted.",
		...
		"请选择接待策略":                                           "Select a reception strategy.",
