...
func TestNewServerRegistersGinRoutes(t *testing.T) {
	...
	expected := []string{
		...
		http.MethodPost + " /api/miniprogram/arrival/bootstrap",
		http.MethodPost + " /api/miniprogram/arrival/bind",
		http.MethodGet + " /api/miniprogram/arrival/status",
		...
		http.MethodPost + " /api/dashboard/conversation/send_arrival_binding_card",
		...
		http.MethodPost + " /api/dashboard/conversation/customer_tag/add",
		http.MethodPost + " /api/dashboard/conversation/customer_tag/remove",
		http.MethodPost + " /api/dashboard/conversation/customer_tag/replace",
		http.MethodGet + " /api/dashboard/tag/list",
		http.MethodPost + " /api/dashboard/tag/update",
		http.MethodPost + " /api/dashboard/tag/update_status",
		...
		http.MethodGet + " /api/dashboard/arrival-connection/protocol-instance/options",
		http.MethodPost + " /api/dashboard/arrival-connection/provider/update",
	...
	for _, route := range []string{
		...
		http.MethodPost + " /api/dashboard/tag/create",
		http.MethodPost + " /api/dashboard/tag/delete",
		http.MethodPost + " /api/dashboard/tag/update_sort",
