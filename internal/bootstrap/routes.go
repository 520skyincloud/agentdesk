...
func registerThirdWxWorkCLIRoutes(group *gin.RouterGroup) {
	...
	group.POST("/outbox/sent", third.WxWorkCLIPostOutboxSent)
	group.POST("/outbox/failed", third.WxWorkCLIPostOutboxFailed)
}

func registerThirdWxWorkProtocolRoutes(group *gin.RouterGroup) {
...
func registerApiMiniprogramRoutes(group *gin.RouterGroup) {
...
func registerDashboardWxWorkProtocolInstanceRoutes(group *gin.RouterGroup) {
	group.GET("/:id", dashboard.WxWorkProtocolInstanceGetBy)
	...
	group.POST("/sync_room_info", dashboard.WxWorkProtocolInstancePostSync_room_info)
...
func registerDashboardKnowledgeBaseRoutes(group *gin.RouterGroup) {
	...
	group.POST("/fastgpt/readiness", dashboard.FastGPTDatasetPostReadiness)
	group.POST("/fastgpt/resync", dashboard.FastGPTDatasetPostResync)
}
...
func registerDashboardKnowledgeCandidateRoutes(group *gin.RouterGroup) {
	group.Any("/list", dashboard.KnowledgeCandidateAnyList)
