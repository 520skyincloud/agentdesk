...
func TestTenantIntegrityAuditPassesCleanTwoTenantFixture(t *testing.T) {
	...
	if report.RequiredTables != 111 || report.ConfiguredRelations != 269 {
		t.Fatalf("audit schema coverage = %d tables/%d relations, want 111/269", report.RequiredTables, report.ConfiguredRelations)
	}
