...
func TestRemoteSetupEmailCodeCreatesStableStoreAccount(t *testing.T) {
	...
	instance := &models.WxWorkProtocolInstance{
		Guid: "device-a", ChannelID: 1, RemoteSetupToken: "setup-token", Status: enums.StatusDisabled,
...
func setupEmailLifecycleTestDB(t *testing.T) *gorm.DB {
	...
	if err := db.AutoMigrate(
		&models.EmailVerificationCode{}, &models.User{}, &models.Role{}, &models.UserRole{},
