...
func tenantIntegrityTablePolicies() map[string]tenantIntegrityTablePolicy {
	...
	return map[string]tenantIntegrityTablePolicy{
		...
		"FastGPTRemoteResourceRetirement": positive,
...
func tenantIntegrityRelations() []tenantIntegrityRelation {
	...
	return []tenantIntegrityRelation{
		...
		tenant("KnowledgeResourceGroup", "company_id", "Company", false),
		...
		tenant("FastGPTRemoteResourceRetirement", "store_id", "Store", true),
		tenant("FastGPTRemoteResourceRetirement", "legacy_knowledge_base_id", "KnowledgeBase", true),
		tenant("FastGPTRemoteResourceRetirement", "replacement_knowledge_base_id", "KnowledgeBase", false),
		...
		tenant("AIUsageEvent", "company_id", "Company", false),
