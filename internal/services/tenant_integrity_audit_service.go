...
func tenantIntegrityTablePolicies() map[string]tenantIntegrityTablePolicy {
	...
	return map[string]tenantIntegrityTablePolicy{
		...
		"ConversationChannelSession":    positive,
		"ConversationContinuityLink":    positive,
		"Store":                         positive,
		"StoreStaffBinding":             positive,
		"WxWorkProtocolInstance":        {AllowZeroCondition: "c.agent_team_id = 0 AND c.channel_id = 0 AND c.store_id = 0 AND c.store_staff_binding_id = 0"},
		...
		"ConversationTakeoverRequest":   positive,
		"QuickReply":                    positive,
		"AIAgent":                       positive,
		"Channel":                       positive,
		...
		"KnowledgeActionBinding":        positive,
		"KnowledgeEvidenceMetadata":     positive,
...
func tenantIntegrityRelations() []tenantIntegrityRelation {
	...
	return []tenantIntegrityRelation{
		...
		tenant("Conversation", "store_id", "Store", false),
		tenant("Conversation", "store_staff_binding_id", "StoreStaffBinding", false),
		tenant("ConversationChannelSession", "conversation_id", "Conversation", true),
		tenant("ConversationChannelSession", "store_id", "Store", false),
		tenant("ConversationChannelSession", "store_staff_binding_id", "StoreStaffBinding", false),
		tenant("ConversationChannelSession", "wx_work_instance_id", "WxWorkProtocolInstance", false),
		tenant("ConversationChannelSession", "channel_id", "Channel", false),
		tenant("ConversationContinuityLink", "store_id", "Store", true),
		tenant("ConversationContinuityLink", "customer_id", "Customer", true),
		tenant("ConversationContinuityLink", "predecessor_conversation_id", "Conversation", true),
		tenant("ConversationContinuityLink", "successor_conversation_id", "Conversation", true),
		...
		tenant("StoreArrivalConnection", "store_staff_binding_id", "StoreStaffBinding", false),
		...
		tenant("ArrivalContactWay", "tenant_authorization_id", "WeComTenantAuthorization", false),
		...
		tenant("ArrivalStoreBinding", "store_staff_binding_id", "StoreStaffBinding", true),
		tenant("ArrivalStoreBinding", "mini_program_identity_id", "MiniProgramIdentity", true),
		tenant("ArrivalStoreBinding", "tenant_authorization_id", "WeComTenantAuthorization", false),
		...
		tenant("ArrivalStoreBinding", "binding_ticket_id", "ArrivalBindingTicket", false),
		tenant("ArrivalBindingTicket", "store_id", "Store", true),
		tenant("ArrivalBindingTicket", "store_staff_binding_id", "StoreStaffBinding", true),
		tenant("ArrivalBindingTicket", "wx_work_protocol_instance_id", "WxWorkProtocolInstance", true),
		tenant("ArrivalBindingTicket", "customer_id", "Customer", true),
		tenant("ArrivalBindingTicket", "conversation_id", "Conversation", true),
		tenant("ArrivalBindingTicket", "consumed_mini_program_identity_id", "MiniProgramIdentity", false),
		tenant("ArrivalBindingTicket", "message_id", "Message", false),
		tenant("ArrivalBindingTicket", "outbox_id", "ChannelMessageOutbox", false),
		...
		tenant("WxWorkCustomerHandoffSetting", "store_staff_binding_id", "StoreStaffBinding", true),
		...
		tenant("AIReplyTurnAction", "turn_id", "AIReplyTurn", true),
		tenant("AIReplyTurnAction", "committed_message_id", "Message", false),
		tenant("AIReplyTurnAction", "outbox_id", "ChannelMessageOutbox", false),
		...
		tenant("KnowledgeEvidenceMetadata", "store_id", "Store", true),
		tenant("KnowledgeEvidenceMetadata", "knowledge_base_id", "KnowledgeBase", false),
		...
		tenant("ConversationDialogueState", "conversation_id", "Conversation", true),
		tenant("ConversationDialogueState", "based_on_message_id", "Message", false),
		...
		tenant("MessageAnalysis", "message_id", "Message", true),
		...
		tenant("ConversationTakeoverRequest", "conversation_id", "Conversation", true),
		tenant("ConversationTakeoverRequest", "team_id", "AgentTeam", true),
		tenant("ConversationTakeoverRequest", "requester_user_id", "User", true),
		tenantOrPlatform("ConversationTakeoverRequest", "source_assignee_id", "User", false),
		tenantOrPlatform("ConversationTakeoverRequest", "reviewer_user_id", "User", false),
		...
		tenant("KnowledgeActionBinding", "store_id", "Store", true),
		tenant("KnowledgeActionBinding", "knowledge_base_id", "KnowledgeBase", true),
		...
		tenant("StoreModelCredentialAuditLog", "credential_id", "StoreModelCredential", false),
