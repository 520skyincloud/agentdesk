...
const RequirementStateSetV1SchemaVersion = SchemaRequirementStateSetV1

// AnswerRequirementSetV1SchemaVersion 同上。
const AnswerRequirementSetV1SchemaVersion = SchemaAnswerRequirementSetV1
...
type ResolvedCoverageItemV1 struct {
	...
	TaskKey         string `json:"taskKey"`
	Status          string `json:"status"` // scheduled/waiting/handoff_pending/covered/routed/ignored/failed/skipped/superseded
	CoveredByTaskID int64  `json:"coveredByTaskId"`
	ReasonCode      string `json:"reasonCode"`
}

// ResolvedTurnCoverageV1SchemaVersion 同上。
const ResolvedTurnCoverageV1SchemaVersion = SchemaResolvedTurnCoverageV1
