...
func TestExecuteIntentHumanRouteSkipsCustomerWithAutoHandoffDisabled(t *testing.T) {
	...
	if err := db.Create(&models.WxWorkProtocolInstance{ID: 771, TenantID: 101, Guid: "intent-route", Status: enums.StatusOk}).Error; err != nil {
		t.Fatalf("create WeCom instance: %v", err)
	}
	conversation := models.Conversation{ID: 81, TenantID: 101, CustomerID: 901, Status: enums.IMConversationStatusAIServing}
