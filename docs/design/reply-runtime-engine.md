...
部署前两个既有 Go 包回归通过；模型是否正确选择需以随后两输入实测为准，
不能把 mock 选择或相关词命中当作语义验收通过。发布结果见开发记录。

## 当前发布状态：2026-09-08 52b44f1

当前运行/opt/agentdesk/releases/20260907-request-answer-52b44f1，
