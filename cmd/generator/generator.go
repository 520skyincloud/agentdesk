...
func main() {
	codegen.GenerateWithOption(
		...
		codegen.GetGenerateStruct(&models.IndustryTagDefinition{}),
		codegen.GetGenerateStruct(&models.Tag{}),
		codegen.GetGenerateStruct(&models.TenantCustomerTagPolicy{}),
		...
		codegen.GetGenerateStruct(&models.MessageAnalysis{}),
		...
		codegen.GetGenerateStruct(&models.AIReplyTurnAction{}),
		codegen.GetGenerateStruct(&models.ConversationDialogueState{}),
		...
		codegen.GetGenerateStruct(&models.ModelProfileTemplate{}),
		codegen.GetGenerateStruct(&models.ModelProfileSlot{}),
		codegen.GetGenerateStruct(&models.StoreModelProfileAssignment{}),
		codegen.GetGenerateStruct(&models.StoreModelCredential{}),
		codegen.GetGenerateStruct(&models.StoreCredentialPolicy{}),
		codegen.GetGenerateStruct(&models.StoreModelCredentialAuditLog{}),
